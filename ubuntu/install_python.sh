...
function build_cpython () {
    ...
    # https://stackoverflow.com/questions/59439725/cant-create-virtualenv-on-ubuntu-18-04-with-python-3-8
...
function main() {
    ...
    install_python "${PYTHON_VERSION_TAG}"
